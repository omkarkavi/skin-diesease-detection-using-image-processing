...
for im in ar:
	...
	ok=svm.SVC(C=0.65, kernel='rbf', degree=7, gamma=2, coef0=0.0, shrinking=False, probability=False, tol=0.015, cache_size=300, class_weight=None, verbose=True, max_iter=-1, decision_function_shape='ovr', random_state=None)
	kavi=svm.SVC(C=0.65, kernel='rbf', degree=3, gamma=0.498, coef0=0.0, shrinking=False, probability=False, tol=0.015, cache_size=300, class_weight=None, verbose=True, max_iter=-1, decision_function_shape='ovr', random_state=None)
...
for i in range(len(ar)/2):
	pdf.add_page()
	ed=((gog[2*i][0]-gog[2*i+1][0])**2+(gog[2*i][1]-gog[2*i+1][1])**2+(gog[2*i][2]-gog[2*i+1][2])**2+(gog[2*i][3]-gog[2*i+1][3])**2+(gog[2*i][4]-gog[2*i+1][4])**2)**0.5
	canbis=(abs(gog[2*i][0]-gog[2*i+1][0])+abs(gog[2*i][1]-gog[2*i+1][1])+abs(gog[2*i][2]-gog[2*i+1][2])+abs(gog[2*i][3]-gog[2*i+1][3])+abs(gog[2*i][4]-gog[2*i+1][4]))/float(abs(gog[2*i][0]+gog[2*i+1][0]+gog[2*i][1]+gog[2*i+1][1]+gog[2*i][2]+gog[2*i+1][2]+gog[2*i][3]+gog[2*i+1][3]+gog[2*i][4]+gog[2*i+1][4]))
	if canbis==0:
		canbis=["not significant"]
	pdf.image(ar[2*i])
	pdf.image(ar[2*i+1])
	pdf.add_page()
	pdf.cell(0, 0,"change "+str(canbis[0]) , 1, 1, 'C')
	pdf.add_page()
	pdf.cell(0, 0,"change "+str(ed[0]) , 1, 1, 'C')
pdf.output("Quantify.pdf")		 
